...
model ConflictPrio
  ...
  PNlib.CPN.PD P1(nIn = 1, nOut = 2, startTokens = 2) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.CPN.TD T1(nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{0, 10}, {20, 30}})));
  PNlib.CPN.TD T2(nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{0, -30}, {20, -10}})));
  PNlib.CPN.PD P2(nIn = 1) annotation(Placement(transformation(extent = {{30, 10}, {50, 30}})));
  PNlib.CPN.PD P3(nIn = 1) annotation(Placement(transformation(extent = {{30, -30}, {50, -10}})));
  PNlib.CPN.TD T3(nOut = 1) annotation(Placement(transformation(extent = {{-60, -10}, {-40, 10}})));
  inner PNlib.CPN.Settings settings annotation(Placement(transformation(extent = {{-60, 20}, {-40, 40}})));
equation

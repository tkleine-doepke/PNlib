...
model TATest
 extends Modelica.Icons.Example;
  ...
  PNlib.PN.Components.PC P1( nIn=1,nOut=2, nOutExt = 1) annotation(Placement(transformation(extent={{-70, -10}, {-50, 10}})));
  PNlib.PN.Components.PC P2(nIn=1, nOutExt=1) annotation(Placement(transformation(extent={{10, -10}, {30, 10}})));
  ...
  PNlib.PN.Components.TC T3( arcWeightIn={ 2}, maximumSpeed= 1,nIn= 1, nInExt = 1, nOut=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}}, rotation=0, origin={80, 0})));
equation

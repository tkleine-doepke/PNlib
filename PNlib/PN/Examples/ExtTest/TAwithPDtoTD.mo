...
model TAwithPDtoTD
  ...
  PNlib.PN.Components.TA TA1(testValue=3) annotation(Placement(visible = true, transformation(extent = {{-18, 26}, {-4, 32}}, rotation = 0)));
...
equation
  ...
  connect(TA1.outExt, T2.extIn[1]) annotation(
    Line(points = {{-3.27778, 29.6727}, {12.7222, 29.6727}, {12.7222, 29.6727}, {12.7222, 29.6727}}));
  connect(TA1.inExt, P1.extOut[1]) annotation(

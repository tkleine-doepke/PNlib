...
model TFDStest
  ...
  PNlib.PN.Components.PD P1(nIn = 0, nOut = 1, startTokens = 5) annotation(
  ...
  PNlib.PN.Components.TFDS T1(b = 2, c = 1,distributionType = PNlib.Types.DistributionType.Triangular, localSeed = 5, nIn = 1, nOut = 1)  annotation(

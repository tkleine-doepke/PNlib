...
model TESTest
  ...
  PNlib.PN.Components.TE T2(event = {3, 4, 5, 9}, nOut = 1)  annotation(
    Placement(visible = true, transformation(origin = {-66, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.PN.Components.TES T1(distributionType = PNlib.Types.DistributionType.Triangular, nIn = 1, nOut = 1)  annotation(

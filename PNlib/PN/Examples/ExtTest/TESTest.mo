...
model TESTest
  ...
  PNlib.PN.Components.PD P1(nIn = 1, nOut = 1, startTokens= 1) annotation(Placement(visible = true, transformation(extent = {{-48, -20}, {-28, 0}}, rotation = 0)));
  PNlib.PN.Components.PD P2(nIn=1) annotation(Placement(visible = true, transformation(extent = {{12, -20}, {32, 0}}, rotation = 0)));
  PNlib.PN.Components.TD T2( nOut = 1, timeType = PNlib.Types.TimeType.Event,timeValue = {3, 4, 5, 9})  annotation(
    Placement(visible = true, transformation(origin = {-66, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.PN.Components.TS T1(distributionType = PNlib.Types.DistributionType.Triangular, nIn = 1, nOut = 1, timeType = PNlib.Types.StoTimeType.Event)  annotation(

...
model DoubleArcwithPTtoTD
  ...
  PNlib.PN.Components.IA IA1(testValue=3, normalArc=false) annotation(Placement(transformation(extent={{-24, 28}, {-12, 32}})));
  PNlib.PN.Components.PD P1(nOut=2, startTokens=5) annotation(Placement(transformation(extent={{-54, -8}, {-34, 12}})));
  ...
  PNlib.PN.Components.TA TA1(normalArc=false, testValue=2) annotation(Placement(transformation(extent={{-20, -32}, {-6, -26}})));
  PNlib.PN.Components.TD T1(nOut=1, nIn=1) annotation(Placement(transformation(extent={{6, 20}, {26, 40}})));
  PNlib.PN.Components.TD T2(nIn=1, nOut=1) annotation(Placement(transformation(extent={{6, -38}, {26, -18}})));
equation

...
model TDSTestinterrupt
  ...
  PNlib.PN.Components.TDS T1(a = 0.5, b = 1.5, c = 1,distributionType=PNlib.Types.DistributionType.Triangular, localSeed=1, nIn=1, nOut=1) annotation(Placement(visible = true, transformation(extent = {{-18, -20}, {2, 0}}, rotation = 0)));
  PNlib.PN.Components.TE T2(event = {0.4}, nIn = 1)  annotation(
    Placement(visible = true, transformation(origin = {-8, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.PN.Components.TE T3(event = {2, 4}, nOut = 1)  annotation(

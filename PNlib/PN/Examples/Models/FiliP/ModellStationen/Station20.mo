...
model Station20
  ...
  equation
    ...
    connect(station.placeOutDis[60], pflegekraft20.transitionIn[3]);
    connect(station.placeOutDis[59], pflegekraft20.transitionIn[2]);
    connect(station.placeOutDis[58], pflegekraft20.transitionIn[1]);
    connect(station.placeOutDis[57], pflegekraft19.transitionIn[3]);
    connect(station.placeOutDis[56], pflegekraft19.transitionIn[2]);
    connect(station.placeOutDis[55], pflegekraft19.transitionIn[1]);
    connect(station.placeOutDis[54], pflegekraft18.transitionIn[3]);
    connect(station.placeOutDis[53], pflegekraft18.transitionIn[2]);
    connect(station.placeOutDis[52], pflegekraft18.transitionIn[1]);
    connect(station.placeOutDis[51], pflegekraft17.transitionIn[3]);
    connect(station.placeOutDis[50], pflegekraft17.transitionIn[2]);
    connect(station.placeOutDis[49], pflegekraft17.transitionIn[1]);
    connect(station.placeOutDis[48], pflegekraft16.transitionIn[3]);
    connect(station.placeOutDis[47], pflegekraft16.transitionIn[2]);
    connect(station.placeOutDis[46], pflegekraft16.transitionIn[1]);
    connect(station.placeOutDis[45], pflegekraft15.transitionIn[3]);
    connect(station.placeOutDis[44], pflegekraft15.transitionIn[2]);
    connect(station.placeOutDis[43], pflegekraft15.transitionIn[1]);
    connect(station.placeOutDis[42], pflegekraft14.transitionIn[3]);
    connect(station.placeOutDis[41], pflegekraft14.transitionIn[2]);
    connect(station.placeOutDis[40], pflegekraft14.transitionIn[1]);
    connect(station.placeOutDis[39], pflegekraft13.transitionIn[3]);
    connect(station.placeOutDis[38], pflegekraft13.transitionIn[2]);
    connect(station.placeOutDis[37], pflegekraft13.transitionIn[1]);
    connect(station.placeOutDis[36], pflegekraft12.transitionIn[3]);
    connect(station.placeOutDis[35], pflegekraft12.transitionIn[2]);
    connect(station.placeOutDis[34], pflegekraft12.transitionIn[1]);
    connect(station.placeOutDis[33], pflegekraft11.transitionIn[3]);
    connect(station.placeOutDis[32], pflegekraft11.transitionIn[2]);
    connect(station.placeOutDis[31], pflegekraft11.transitionIn[1]);
    connect(station.placeOutDis[30], pflegekraft10.transitionIn[3]);
    connect(station.placeOutDis[29], pflegekraft10.transitionIn[2]);
    connect(station.placeOutDis[28], pflegekraft10.transitionIn[1]);
    connect(station.placeOutDis[27], pflegekraft9.transitionIn[3]);
    connect(station.placeOutDis[26], pflegekraft9.transitionIn[2]);
    connect(station.placeOutDis[25], pflegekraft9.transitionIn[1]);
    connect(station.placeOutDis[24], pflegekraft8.transitionIn[3]);
    connect(station.placeOutDis[23], pflegekraft8.transitionIn[2]);
    connect(station.placeOutDis[22], pflegekraft8.transitionIn[1]);
    connect(station.placeOutDis[21], pflegekraft7.transitionIn[3]);
    connect(station.placeOutDis[20], pflegekraft7.transitionIn[2]);
    connect(station.placeOutDis[19], pflegekraft7.transitionIn[1]);
    connect(station.placeOutDis[18], pflegekraft6.transitionIn[3]);
    connect(station.placeOutDis[17], pflegekraft6.transitionIn[2]);
    connect(station.placeOutDis[16], pflegekraft6.transitionIn[1]);
    connect(station.placeOutDis[15], pflegekraft5.transitionIn[3]);
    connect(station.placeOutDis[14], pflegekraft5.transitionIn[2]);
    connect(station.placeOutDis[13], pflegekraft5.transitionIn[1]);
    connect(station.placeOutDis[12], pflegekraft4.transitionIn[3]);
    connect(station.placeOutDis[11], pflegekraft4.transitionIn[2]);
    connect(station.placeOutDis[10], pflegekraft4.transitionIn[1]);
    connect(station.placeOutDis[9], pflegekraft3.transitionIn[3]);
    connect(station.placeOutDis[8], pflegekraft3.transitionIn[2]);
    connect(station.placeOutDis[7], pflegekraft3.transitionIn[1]);
    connect(station.placeOutDis[6], pflegekraft2.transitionIn[3]);
    connect(station.placeOutDis[5], pflegekraft2.transitionIn[2]);
    connect(station.placeOutDis[4], pflegekraft2.transitionIn[1]);
    connect(station.placeOutDis[3], pflegekraft1.transitionIn[3]);
    connect(station.placeOutDis[2], pflegekraft1.transitionIn[2]);
    connect(station.placeOutDis[1], pflegekraft1.transitionIn[1]);

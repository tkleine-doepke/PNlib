...
model ConflictBeneQuotient
  ...
  PNlib.PN.Components.PD P1(benefitType = PNlib.Types.BenefitType.BenefitQuotient, enablingBeneOut = {10, 7}, enablingType = PNlib.Types.EnablingType.Benefit,nIn = 1, nOut = 2, startTokens = 9) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.PN.Components.TD T1(arcWeightIntIn = {5},nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{0, 10}, {20, 30}})));
  PNlib.PN.Components.TD T2(arcWeightIntIn = {3},nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{0, -30}, {20, -10}})));
  ...
  PNlib.PN.Components.TD T3(arcWeightIntOut = {4}, nOut = 1) annotation(Placement(transformation(extent = {{-60, -10}, {-40, 10}})));

...
model ConflictBeneQuotient
  ...
  PNlib.PN.Components.TD T1(arcWeightIn = {5},nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{0, 10}, {20, 30}})));
  PNlib.PN.Components.TD T2(arcWeightIn = {3},nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{0, -30}, {20, -10}})));
  ...
  PNlib.PN.Components.TD T3(arcWeightOut = {4}, nOut = 1) annotation(Placement(transformation(extent = {{-60, -10}, {-40, 10}})));

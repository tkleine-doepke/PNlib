...
model ConflictBeneBaB
  ...
  PNlib.PN.Components.TD T1(arcWeightIntIn = {4},nIn = 1, nOut = 1) annotation(Placement(visible = true, transformation(extent = {{-6, 70}, {14, 90}}, rotation = 0)));
  PNlib.PN.Components.TD T2(arcWeightIntIn = {3},nIn = 1, nOut = 1) annotation(Placement(visible = true, transformation(extent = {{-6, 30}, {14, 50}}, rotation = 0)));
  ...
  PNlib.PN.Components.TD T3(arcWeightIntIn = {1},nIn = 1, nOut = 1)  annotation(
    Placement(visible = true, transformation(origin = {4, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.PN.Components.TD T4(arcWeightIntIn = {1},nIn = 1, nOut = 1)  annotation(
    Placement(visible = true, transformation(origin = {4, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.PN.Components.TD T5(arcWeightIntIn = {1},nIn = 1, nOut = 1)  annotation(

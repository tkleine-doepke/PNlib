...
model PDtoTD
  ...
  inner PNlib.PN.Settings settings annotation(Placement(transformation(extent={{20, 20},
            {40, 40}})));
  PNlib.PN.PD P1(nOut = 1, startTokens = 10) annotation(Placement(transformation(extent={{-30, -10},
            {-10, 10}})));
  PNlib.PN.TD T1(nIn = 1) annotation(Placement(transformation(extent={{10, -10}, {30,
            10}})));
equation

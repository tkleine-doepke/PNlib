...
model OutputConflictPrio
  ...
  PNlib.PN.Components.PD P1(nIn = 1, startTokens = 2, nOut = 2, minTokens = 2) annotation(Placement(transformation(extent={{-30, -10},
            {-10, 10}})));
  ...
  PNlib.PN.Components.PD P3(nIn = 1) annotation(Placement(transformation(extent={{30, -30}, {50,
            -10}})));

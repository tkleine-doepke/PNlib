...
model Conflict
  ...
  PNlib.PN.Components.TC T1(nOut = 1) annotation(Placement(transformation(extent={{-40, -10}, {
            -20, 10}})));
  PNlib.PN.Components.TC T2(maximumSpeed = 2, nIn = 1, nOut = 1) annotation(Placement(transformation(extent={{20, 10},
            {40, 30}})));
  PNlib.PN.Components.TC T3(nIn = 1, nOut = 1) annotation(Placement(transformation(extent={{20, -30},
            {40, -10}})));
  PNlib.PN.Components.PC P1(nIn = 1, nOut = 2) annotation(Placement(transformation(extent={{-10, -10},
            {10, 10}})));
  PNlib.PN.Components.PC P2(nIn = 1) annotation(Placement(transformation(extent={{50, 10}, {70,
            30}})));
  PNlib.PN.Components.PC P3(nIn = 1) annotation(Placement(transformation(extent={{50, -30}, {70,
            -10}})));

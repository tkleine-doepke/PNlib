...
model ZeroArcWeight
  ...
  PNlib.PN.Components.PC P1(nOut=1)
    annotation(Placement(transformation(extent={{-50, 10}, {-30, 30}})));
  PNlib.PN.Components.PC P2(nOut=1, startMarks=10)
    annotation(Placement(transformation(extent={{-50, -30}, {-30, -10}})));
  PNlib.PN.Components.TC T1(nIn=2, nOut=1, arcWeightIn={0, 1})
    annotation(Placement(transformation(extent={{-10, -10}, {10, 10}})));
  PNlib.PN.Components.PC P3(nIn=1)

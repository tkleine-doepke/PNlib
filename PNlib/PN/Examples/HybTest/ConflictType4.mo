...
model ConflictType4
  ...
  PNlib.PN.Components.PC P1(nOutCon = 1, startMarks = 10) annotation(Placement(transformation(extent={{-50, 10}, {-30, 30}})));
  PNlib.PN.Components.PC P2(nInCon = 1)  annotation(Placement(transformation(extent={{30, 10}, {50, 30}})));
  PNlib.PN.Components.PC P3(nOutCon = 1, startMarks = 10) annotation(Placement(transformation(extent={{-50, -50}, {-30, -30}})));
...
equation
  ...
  connect(T1.outPlacesCon[1], P4.inTransition[1]) annotation(
    Line(points = {{4, -40}, {28, -40}, {28, -40}, {30, -40}}, thickness = 0.5));
  connect(P3.outTransition[1], T1.inPlacesCon[1]) annotation(
    Line(points = {{-30, -40}, {-4, -40}, {-4, -40}, {-4, -40}}, thickness = 0.5));
  connect(T2.outPlacesCon[1], P2.inTransition[1]) annotation(
    Line(points = {{4, 20}, {28, 20}, {28, 20}, {30, 20}}, thickness = 0.5));
  connect(P1.outTransition[1], T2.inPlacesCon[1]) annotation(

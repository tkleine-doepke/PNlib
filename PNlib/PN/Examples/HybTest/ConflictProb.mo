...
extends Modelica.Icons.Example;
  PNlib.PN.Components.PC P1(enablingType = PNlib.Types.EnablingType.Probability, localSeedIn = 1, localSeedOut = 2,nInDis = 1, nOutDis = 2, startMarks = 2) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  ...
  PNlib.PN.Components.PD P2(localSeedIn = 3, localSeedOut = 4, nIn = 1)  annotation(Placement(transformation(extent = {{30, 10}, {50, 30}})));
  PNlib.PN.Components.PD P3(localSeedIn = 5, localSeedOut = 6, nIn = 1)  annotation(Placement(transformation(extent = {{30, -30}, {50, -10}})));

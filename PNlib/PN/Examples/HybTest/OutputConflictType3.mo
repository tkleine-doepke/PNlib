...
model OutputConflictType3
  ...
  PNlib.PN.Components.PC P1(nIn = 1, nOut = 2, startMarks=2) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.PN.Components.TC T1(nIn = 1, nOut = 1, maximumSpeed=2) annotation(Placement(transformation(extent = {{0, 10}, {20, 30}})));
  ...
  PNlib.PN.Components.TC T3(nOut = 1) annotation(Placement(transformation(extent = {{-60, -10}, {-40, 10}})));
